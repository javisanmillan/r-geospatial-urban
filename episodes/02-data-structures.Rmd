...
across other data structures such as factors, data frames, lists and matrices as well.
In short:

- factors are special data structures used to store categorical variables. Although they often resemble character vectors, factors store levels internally as integers.
